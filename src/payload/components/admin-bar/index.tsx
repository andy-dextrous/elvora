...
export async function WildChildAdminBar({
	preview,
	user,
	settings,
}: AdminBarProps) {
	...
	return (
		<>
			...
			<Toaster
				...
				icons={{
					success: (
						<FaCheckCircle className="admin-bar__toaster-success-icon" />
					),
					error: (
						<FaExclamationCircle className="admin-bar__toaster-error-icon" />
					),
				}}
